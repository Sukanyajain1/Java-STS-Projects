package com.sj.loginreg.models;
...
public class User {
	...
	public User(Long id,
			@NotEmpty(message="This field must be completed.") @Size(min = 3, max = 30, message = "Username must be between 3 and 30 characters") String userName,
